...
def test_select_straight():
    result = [x for x in hand.fromname("22223333").select_straight()]
    assert len(result) == 0
...
def test_select_straight_2():
    ...
    :return:
    """
    result = [x for x in hand.fromname("3456789TJQKA2").select_straight()]
    assert len(result) == 1
...
def test_select_straight_3():
    ...
    :return:
    """
    result = [x for x in hand.fromname("345678934567").select_straight()]
    assert len(result) == 1
...
def test_select_straight_4():
    ...
    :return:
    """
    result = [x for x in hand.fromname("345678TJQKA2").select_straight()]
    assert len(result) == 2
